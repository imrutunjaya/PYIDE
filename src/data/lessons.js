export const lessons = [
  {
    ...
    "category": "Step 1: The Absolute Basics",
    "difficulty": "Basic",
    ...
    "lineExplanations": {
      "1": "The print() command tells the computer to show whatever is inside the parentheses on the screen."
    },
  ...
  {
    "id": "micro-2",
    "title": "Lesson 2: Talking with Text",
    "category": "Step 1: The Absolute Basics",
    "difficulty": "Basic",
    ...
    "lineExplanations": {
      "1": "The quotes around \"Hello\" tell the computer: 'Don't try to understand this word, just print it out exactly as it is.' This is called a String."
    },
  ...
  {
    "id": "micro-3",
    "title": "Lesson 3: The Storage Box",
    "category": "Step 2: Remembering Things",
    "difficulty": "Basic",
    ...
    "lineExplanations": {
      "1": "Creates a storage box named 'age' and puts the number 20 inside it.",
      "2": "Looks inside the box named 'age' and prints whatever is inside (20)."
    },
  ...
  {
    "id": "micro-4",
    "title": "Lesson 4: Doing Math",
    "category": "Step 3: Doing Work",
    "difficulty": "Basic",
    ...
    "lineExplanations": {
      "1": "Calculates 10 + 5, gets 15, and stores the 15 inside the 'result' box.",
      "2": "Prints the number 15."
    },
  ...
  {
    "id": "micro-5",
    "title": "Lesson 5: Making a Decision",
    "category": "Step 4: Logic",
    "difficulty": "Basic",
    ...
    "lineExplanations": {
      "1": "Stores 20 in 'age'.",
      "2": "Checks if age is greater than 18. The colon ':' means 'If true, do the indented stuff below'.",
      "3": "Because it is indented, this line ONLY runs if line 2 is True."
    },
  ...
  {
    "id": "micro-6",
    "title": "Lesson 6: The List Collection",
    "category": "Step 5: Intermediate",
    ...
    "lineExplanations": {
      "1": "Creates a list containing two string items and stores it in the 'fruits' variable.",
      "2": "Prints the whole list."
    },
  ...
  {
    "id": "micro-7",
    "title": "Lesson 7: Adding to a List",
    "category": "Step 5: Intermediate",
    "difficulty": "Intermediate",
    ...
    "lineExplanations": {
      "1": "Creates a list with one item.",
      "2": "Adds 'banana' to the very end of the list.",
      "3": "Prints the new list, which now has two items."
    },
  ...
  },
  {
    ...
    "lineExplanations": {
      "1": "Creates a list of 3 fruits.",
      "2": "Starts a loop. It pulls out the first item, calls it 'fruit', and runs the indented code. Then repeats for the next item.",
      "3": "Prints whatever item is currently pulled out."
    },
  ...
  },
  {
    ...
    "lineExplanations": {
      "1": "Creates a Dictionary with two keys ('name' and 'age') and their corresponding values.",
      "2": "Looks inside the 'person' dictionary for the key 'name', and prints its value ('Alice')."
    },
  ...
  {
    "id": "micro-10",
    "title": "Lesson 10: Custom Commands (Functions)",
    "category": "Step 6: Advanced",
    "difficulty": "Advanced",
    ...
    "lineExplanations": {
      "1": "Defines a new function named 'say_hello'.",
      "2": "The code that runs when 'say_hello' is called.",
      "3": "Blank space.",
      "4": "Actually executes the custom command you just created."
    },
  ...
  {
    "id": "micro-11",
    "title": "Lesson 11: Functions with Inputs",
    "category": "Step 6: Advanced",
    "difficulty": "Advanced",
    ...
    "lineExplanations": {
      "1": "Defines a function 'greet' that expects one piece of information, which it will temporarily call 'name'.",
      "2": "Prints 'Hello ' followed by whatever name was given.",
      "3": "Blank space.",
      "4": "Calls greet, giving it the string 'Alice'.",
      "5": "Calls greet again, this time giving it 'Bob'."
    },
  ...
  {
    "id": "micro-12",
    "title": "Lesson 12: Object Blueprints (Classes)",
    "category": "Step 7: Mastery",
    "difficulty": "Advanced",
    ...
    "lineExplanations": {
      "1": "Creates a blueprint named 'Dog'.",
      "2": "Defines a capability (method) for this blueprint called 'bark'. The 'self' means 'the specific object doing the barking'.",
      "3": "Prints Woof.",
      "4": "Blank space.",
      "5": "Creates a brand new object using the Dog blueprint, and stores it in 'my_dog'.",
      "6": "Tells that specific object to use its bark capability."
    },
